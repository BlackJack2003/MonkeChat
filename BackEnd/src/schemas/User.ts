...
export interface EmailInt extends Email, mongoose.Document {}

const emailSchema = new mongoose.Schema<EmailInt>({
...
//   }>;
//   groupChats: mongoose.Types.Array<mongoose.Types.ObjectId>;
// }

// export interface UserInt extends User, mongoose.Document {}
