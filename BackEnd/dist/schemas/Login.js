...
exports.Email = mongoose_1.default.models.email || mongoose_1.default.model("email", emailSchema);
...
userSchema.post("deleteMany", function (res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield exports.Email.deleteMany({
                _id: { $in: this.map((doc) => doc.email) },
            }).exec();
            next();
        }
        catch (err) {
